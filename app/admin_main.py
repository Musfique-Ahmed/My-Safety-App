...
from app.core.security import require_admin  # JWT bearer-token admin guard for /api/admin/* routes
from app.db import fetch_all, fetch_one, execute, parse_json_field, insert_and_get_id
